...
(function($)
{
    ...
    $.widget('blueimp.fileupload', {
        ...
        _onAdd:function(e, data)
        {
            ...
            var that = this, result = true, options = $.extend({}, this.options, data), fileSet = data.files, limit = options.limitMultiFileUploads, i;
        ...
        _initEventHandlers:function()
        {
            ...
            {
                return widget._onChange(e);
            };

            this.options.fileInput
                .bind('change.' + ns, {fileupload:this}, change);
        },

...
return array (
  ...
  '{attribute} cannot be blank.' => 'Поле {attribute} является обязательным для заполнения.',
  ...
  '{attribute} is not a valid email address.' => 'Вы не корректно указали E-mail адрес.',

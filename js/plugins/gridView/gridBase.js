(function($)
{
     ...
     * Т.е. если вы хотите проинициализировать плагин из какой-либо колонки, то нужно
     * это сделать не в методе init, а в методе renderDataCellContent или подобном ему.
     */
